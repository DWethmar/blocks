...
export abstract class GameObject {
    ...
    // Direction
    get dX() { return getX(this.direction); }
    set dX(value: number) { this.direction[0] = value }

    get dY() { return getY(this.direction); }
    set dY(value: number) { this.direction[1] = value }

    get dZ() { return getZ(this.direction); }
    set dZ(value: number) { this.direction[2] = value }
